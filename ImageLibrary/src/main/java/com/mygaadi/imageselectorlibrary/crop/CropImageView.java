package com.mygaadi.imageselectorlibrary.crop;
...
public class CropImageView extends ImageViewTouchBase {
    ...
    ArrayList<com.mygaadi.imageselectorlibrary.crop.HighlightView> highlightViews = new ArrayList<com.mygaadi.imageselectorlibrary.crop.HighlightView>();
    com.mygaadi.imageselectorlibrary.crop.HighlightView motionHighlightView;
    Context context;
    ...
    protected void zoomTo(float scale, float centerX, float centerY) {
        ...
        for (com.mygaadi.imageselectorlibrary.crop.HighlightView hv : highlightViews) {
            hv.matrix.set(getUnrotatedMatrix());
            hv.invalidate();
        }
    }
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        com.mygaadi.imageselectorlibrary.crop.CropImageActivity cropImageActivity = (com.mygaadi.imageselectorlibrary.crop.CropImageActivity) context;
        ...
        case MotionEvent.ACTION_DOWN:
            for (com.mygaadi.imageselectorlibrary.crop.HighlightView hv : highlightViews) {
                ...
                if (edge != com.mygaadi.imageselectorlibrary.crop.HighlightView.GROW_NONE) {
                    motionEdge = edge;
